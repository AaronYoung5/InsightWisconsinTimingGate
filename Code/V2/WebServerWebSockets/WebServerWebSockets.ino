...
IPAddress IP(192,168,4,15); // The IP address and mask of ESP8266
IPAddress mask = (255,255,255,0);

const char *OTAName = "ESP8266";           // A name and a password for the OTA service
const char *OTAPassword = "password";

#define LED LED_BUILTIN            // specify the pins with an RGB LED connected
...
void loop() {
  ...
  if(wait(2000)) {
    ...
    webSocket.sendTXT(socketNumber, "Server data :: " + sensorData);
